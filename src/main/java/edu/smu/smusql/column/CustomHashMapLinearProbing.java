...
public class CustomHashMapLinearProbing<K, V> extends AbstractMap<K, V> {
    ...
    public CustomHashMapLinearProbing(int initialCapacity, float loadFactor, float resizingFactor) {
