...
public class TableCustomDynamicArray extends AbstractTable {

    // create a table with the fixed columns and empty custom dynamic array of rows 
    public TableCustomDynamicArray(String tableName, String[] colNames) {
        ...
        super.setRows(new CustomDynamicArray<Row>());
    }
...
// System.out.println();
        ...
        List<Row> result = new CustomDynamicArray<>();
...
// System.out.println(element.toString());
    ...
    public String select(Column[] cols, List<String> conditions) { // idk the format passed into this method 
        ...
        if (conditions.size() == 0) {
            selectedRows = new CustomDynamicArray<Row>(this.rows);
        } else {
